...
$aux = substr( $_SERVER['REQUEST_URI'], strlen('/posts/'.$categoria1.'/'));
...
<div class="player-post clearfix">
					<a href="/prev.php?id=6037794" class="before hastipsy" title="Post anterior (m&aacute;s viejo)"></a>
					<a href="/rand.php" class="shuffle hastipsy" title="Post aleatorio"></a>

					<a href="/next.php?id=6037794" class="next hastipsy" title="Post siguiente (m&aacute;s nuevo)"></a>
				</div>
							</div>
		</div>
...
<div id="main-col">
	<div id="full-col" class="post">
		<div class="post-content">
      
                  
		<div class="clearfix">
			<ul class="post-share post-share-list">

				<script src="http://connect.facebook.net/es_ES/all.js#xfbml=1"></script>
				<script type="text/javascript">$(document).ready(function(){ $.getScript('http://platform.twitter.com/widgets.js'); });</script>
				<li>
					<a href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal"
					data-via="Taringa"
					data-lang="es"
					data-url="http://www.taringa.net/posts/taringa/6037794/Ayuda_-Tutoriales-e-Informacion-sobre-Taringa.html"
					data-text="Ayuda, Tutoriales e Información sobre Taringa -"></a>
				</li>
				<li>
					<fb:like href="http://www.taringa.net/posts/taringa/6037794/Ayuda_-Tutoriales-e-Informacion-sobre-Taringa.html"
					layout="button_count"
					show-faces="false"
					width="120"
					action="like"
				...
				<li>
					<a href="javascript:notifica.sharePost(6037794)" class="share-t"></a>
					<div class="number-share-t">
						481					</div>
				</li>
			</ul>
			...
			<span class="breadcrumb">
				...
				<a href="/posts/taringa">Taringa!</a> | 
				<span title="05/07/2010 17:04" class="hastipsy">
					M&aacute;s de 10 meses				</a>
			</span>
		</div>
...
<div id="sidebar"><!-- SIDEBAR -->
	...
	<div id="post-author-box" class="box"><!-- POST AUTHOR -->
	<div class="title clearfix">
		<h2 class="author-nick"><a class="textlimit" data-width="162" style="display:block; max-width:162px; overflow:hidden" href="/<?=$row['nick']?>"><?=$row['nick']?></a></h2>
		<div class="action">
			<i class="icon <?php
$rango	=	"SELECT *
			FROM (rangos AS r, usuarios as u)
...
$rng	=	mysql_query($rango, $con);
$rng2	=	mysql_fetch_array($rng);
echo $rng2['nom_rango']?> hastipsy" title="<?php
$rango	=	"SELECT *
			FROM (rangos AS r, usuarios as u)
			WHERE u.rango=r.id_rango
			AND u.id='$id_a'";
$rng	=	mysql_query($rango, $con);
$rng2	=	mysql_fetch_array($rng);
echo $rng2['nom_rango']?>" ></i>

			<i class="icon hastipsy male" title="Hombre"></i>
			<i class="icon flag"><img class="hastipsy country-name" title="Rusia" src="http://o1.t26.net/images/flags/ru.png" width="16" height="11" align="absmiddle" alt="Rusia" hspace="3" /></i>
		</div>
	</div>
	<div class="author clearfix">
		<div class="floatL profile">
			<a href="/<?=$row['nick']?>">
				<img class="big-avatar" src="<?=$row['avatar']?>" onerror="error_avatar(this)" />
			</a>

			 <span class="rank " ><a href="/<?=$row['nick']?>"><?php
$rango	=	"SELECT *
			FROM (rangos AS r, usuarios as u)
			WHERE u.rango=r.id_rango
			AND u.id='$id_a'";
$rng	=	mysql_query($rango, $con);
$rng2	=	mysql_fetch_array($rng);
echo $rng2['nom_rango']?></a></span>
		</div>
		<div class="stats">
			<a name="follow"
		onclick="notifica.follow('user', 283067, notifica.userInpostContext, $(this), false);"
		class="follow-user-post following-button fg-button ui-state-default ui-corner-all box-shadow-soft ui-button ui-widget ui-button-text-only"
		>
		...
		<span class="unfollow-button-text disabled" style="display:none">
			Dejar de Seguir		</span>
				...
				<div id="user-metadata-post">
				<div>
					<i class="icon followers"></i>
					<span class="value followers-count">

						<a class="data-followers-count"
						   data-val="10817"
						   href="/<?=$row['nick']?>/seguidores"><?=$row['seguidores']?></a>
					</span>
					<span>Seguidores</span>
				</div>
				<div>
					<i class="icon points"></i>
					<span class="value" data-val="87446"><?=$row['puntos']?></span>

					<span>Puntos</span>
				</div>
				<div>
					<i class="icon sprite-document-text-image"></i>
										<span class="value" data-val="<?=$row['numposts']?>">
						<a href="/<?=$row['nick']?>/posts">
							<?=$row['numposts']?>						</a>
					</span>
		...
		<div class="clearfix floatL view-more-content" style="width:100%;margin-top:10px">
			<span style="color:#999;font-size:11px">Acerca			de <?=$row['nombre']?> .			</span>


			<p style="font-size:12px;color:#333;margin:0 0 5px 0"><?=$row['mensaje']?></p>

			<a href="/mensajes/a/<?=$row['nick']?>" class="ui-btn ui-state-default mini-btn">
				<i class="icon private-message"></i>
				Enviar mensaje			</a>
		</div>
	</div>
		<div class="read-more clearfix">
		<span class="show-more"><a onclick="nviewmore_authorprofile(true);">Ver m&aacute;s del Autor &raquo;</a></span>

		<span class="show-less" style="display:none"><a onclick="nviewmore_authorprofile(false);">&laquo; Ver menos</a></span>
	</div>
</div>
...
$num=0;
$sqlcom = mysql_query("SELECT * FROM comentarios WHERE id_post='$id' order by id ASC LIMIT $RegistrosAEmpezar, $limit_posts");
		...
		<div class="comment-box">
			...
			<div class="comment-info clearbeta">
				...
				<div class="floatR answerOptions">
					...
					<li><a href="javascript:puntear_comentario2('.$idcoment.',-1);"><span class="voto-n-comentario"></a></li></span>
