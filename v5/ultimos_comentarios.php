...
WHERE p.elim='0' AND {$condicion} ORDER BY c.fecha DESC LIMIT 10 ");
...
<div class="list-element overflow">
				<span class="subinfo">
					<a href="/perfil/'.$com['autor'].'">'.$com['autor'].'</a>

				</span>
				<a href="/posts/'.$com['link_categoria'].'/'.$com['id'].'/'.corregir($com['titulo']).'.html#comentarios-abajo" class="size10">'.cortar($com['titulo']).'</a>	
			</div>
