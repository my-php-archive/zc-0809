...
<div class='emptyData'><div id="ver_on" href="#" onclick="mostrar('bloque')"><font color="black"><img src="/images/add.png"> Agregarle Una Medalla!</font></a></div></div>
...
<br>
<img src="/images/causa.png"> Causa: <input type="text" name="causa" value=""  /> <br /> 
<br>
<img src="/images/detalles.png"> Detalle: <input type="text" name="detalles" value=""  /> <br />
<br>
...
<div class="emptyData">No tiene fotos</div>';
}else{echo'
		  <span>'.$cantidad.'</span>
		</div>';
