...
$sql = "SELECT u.id, u.rango, p.elim, p.id_autor, p.titulo, p.contenido, p.categoria, p.privado, p.coments, p.tags ";
...
if($key==$id_autor and $elim==0 or $moder2['rango']==255 or $moder2['rango']==655 or $moder2['rango']==755 or $moder2['rango']==100)
{
?>
...
if($moder2['rango']==100 or $moder2['rango']==255 or $moder2['rango']==655 or $moder2['rango']==755){
