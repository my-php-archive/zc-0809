...
$tit=0;}
?>
	<li class="categoriaPost clearfix <?=$link_categoria?>">
...
?>
		...
		<div class="boxy xtralarge">
			...
			<div class="boxy-content">
						<ol>
<?php
$sql = "SELECT p.titulo, p.comentarios, p.categoria, p.id, p.fecha, c.id_categoria, c.nom_categoria, c.link_categoria 
		FROM (posts AS p, categorias AS c) 
		WHERE p.categoria=c.id_categoria AND p.elim=0 ".$catego." ".$sort_by." 
		ORDER BY p.comentarios DESC LIMIT 15";
$rs = mysql_query($sql, $con);
 $existecsss=mysql_num_rows($rs);
...
<a href='/posts/<?php echo $link_categoria; ?>/<?php echo $id; ?>/<?php echo corregir($tituloc); ?>.html' alt = '<?php echo $tituloc; ?> - <?php echo $fecha; ?>' title = '<?php echo $tituloc; ?> - <?php echo $fecha; ?>' ><?echo $titulo2; if ($tit==1) echo"...";?></a><span><?php echo $comentarios; ?></span></li>
<?php
}
?>
