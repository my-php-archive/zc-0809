...
if(empty($id_user)){
fatal_error('Para ver los usuarios online debes estar registrado','Ir a p&aacute;gina principal','location.href=\'/\'','CHAN!!');}
$cn='0';
...
<div class='box_cuerpo'>";
  if(!$existe)
    {
      echo'<div class="emptyData">No hay usuarios onlines en este momento.</div>';
    }
...
$cn++;
	...
	echo '<div class="container340 floatL">
			...
			<a href="/perfil/'.$r['nick'].'/"><strong>'.$r['nick'].'</strong></a><br />'.pais($r['pais']).'<br />'.($r['sexo'] == 'f' ? 'Mujer' : 'Hombre').'<br />
			<img src="/images/perfil-online.png" align="absmiddle" border="0" hspace="3" vspace="2"  /><a href="/perfil/'.$r['nick'].'">Ver Perfil</a><br />';
			if($r['imagenes'] != null){echo'
			<img src="/images/con-fotos.png" align="absmiddle" border="0" hspace="3" vspace="2" />Con fotos<br />';}
