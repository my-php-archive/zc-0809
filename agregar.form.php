...
<link href="http://www.zincomienzo.net/images/css/beta_estilos3.css?5.4.9" rel="stylesheet" type="text/css" />
		...
		function(){
			...
			$.ajax({
				...
				success: function(r) {
					...
					mydialog.body(r);
					mydialog.buttons(true, true, '     Agregar post     ', 'postSave()', true, true, true, 'Cerrar previsualizaci\xf3n', 'close', true, false);
					mydialog.center();
			...
			<ul class="clearbeta">
				...
				<li>
					...
					<div id="emoticons" style="margin: 10px 0 0">
                        <a href="#" smile=":)"><span style="position:relative;"><img border=0 src="<?=$images?>/big2.gif" style="position:absolute; top:-286px; clip:rect(286px 16px 302px 0px);" alt="sonrisa" title="sonrisa" /><img border=0 src="http://o2.t26.net/images/space.gif" style="width:20px;height:16px" align="absmiddle" /></span></a>
						<a href="#" smile=";)"><span style="position:relative;"><img border=0 src="<?=$images?>/big2.gif" style="position:absolute; top:-308px; clip:rect(308px 16px 324px 0px);" alt="gui&ntilde;o" title="gui&ntilde;o" /><img border=0 src="http://o2.t26.net/images/space.gif" style="width:20px;height:16px" align="absmiddle" /></span></a>
                        ...
                        <a style="float: right; margin: 5px 0pt 0pt;" onclick="window.open('/emoticones.php', '', 'width=180px,height=500px,scrollbars,resizable')" class="emoticons-more">M&aacute;s Emoticones</a></div>

				</li>

				<li>
					<label>Tags</label>
					<span class="errormsg" style="display: none" tabindex="3"></span>
					<input class="text-inp required" type="text" name="tags" />
...
echo"</select></li>";
if($rangoz['rango']!=11){
	echo"<li class='special-right clearbeta'>
					<label>Opciones</label>
	<div class='option clearbeta'>
						<input class='floatL' type='checkbox' name='privado' tabindex='5' />
						<p class='floatL'>
							<strong>S&oacute;lo usuarios registrados</strong>

							Tu post ser&aacute; visto s&oacute;lo por los usuarios que tengan cuenta en {$comunidad}
						</p>
					</div>

					<div class='option clearbeta'>
						<input class='floatL' type='checkbox' name='coments' tabindex='6' />
						<p class='floatL'>
