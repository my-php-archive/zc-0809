...
<input type="button" class="mBtn btnOk" style="font-size:11px" value="Ir a p&aacute;gina principal" title="Ir a p&aacute;gina principal" onclick="location.href='/'">	<input type="button" class="mBtn btnOk" style="font-size:11px" value="Volver" title="Volver" onclick="history.go(-1)">
