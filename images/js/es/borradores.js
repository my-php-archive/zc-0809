...
var borradores = {
	...
	printResult: function(){
		...
		$.each(this.r, function(i, borrador){
			var h = borradores.template_borrador.replace('__id__', borrador['id']).replace('__categoria__', borrador['categoria']).replace('__tipo__', borrador['tipo']).replace('__categoria_name__', borrador['categoria_name']).replace('__url__', borrador['url']).replace('__titulo__', borrador['titulo']).replace('__causa__', borrador['causa']).replace('__fecha_guardado__', borrador['fecha_print']).replace('__borrador_id__', borrador['id']);
