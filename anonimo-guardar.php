...
$ultimaip = no_i($_POST['ultimaip'], ENT_QUOTES, "UTF-8");

mysql_query("UPDATE usuarios SET id = '$id', nombre = '$nombre',mail = '$mail',ciudad = '$ciudad',sitio_web = '$sitio_web', mensajero = '$mensajero', avatar = '$avatar', nick = '$nick', pais = '$pais', empresa = '$empresa', mensaje = '$mensaje', region = '$region', ultimaip = '$ultimaip' WHERE id = $id");
...
<div class="container400" style="margin: 10px auto 0 auto;">
	...
	<div class="box_cuerpo"  align="center">
		<br />
		El Perfil Se Edito Correctamente!	<br />
		<br />
		<br />
