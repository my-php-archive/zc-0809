...
if($rs['eliminado_receptor']=='1' and $rs['id_receptor']==$sesion or $rs['id_emisor']==$sesion){echo'
...
echo'<div class="box_txt show_error">Confirmaci&oacute;n</div>
	...
	<div class="box_cuerpo"  align="center">
	<br />
	El mensaje ha sido eliminado 		<br />';
mysql_query("UPDATE mensajes SET eliminado_receptor='1' WHERE id_receptor='$sesion' AND id_mensaje='$id_mensaje'");}
