...
<script src="'.$images.'/js/es/cuenta.js?1.1" type="text/javascript"></script>
		...
		<div class="content-tabs cuenta">
			...
			<fieldset>
				<div class="field">
					...
					<input type="text" class="text cuenta-save-1" id="nombre" name="nombre" maxlength="32" value="'.$datos['nombre'].'" />
				</div>
				...
				<div class="field">
					...
					<input type="text" class="text cuenta-save-1" id="nombre" name="apellido" maxlength="32" value="'.$datos['apellido'].'" />
				</div>
...
<div class="field">
					...
					<input type="text" class="text cuenta-save-1 input-hidden-email" id="email" name="email" maxlength="35" value="'.$datos['mail'].'" style="display: none" />
				</div>
				<div class="field">
...
<input type="text" class="text cuenta-save-1" id="dia" name="region" maxlength="255" value="'.$datos['region'].'" />
...
<input type="text" class="text cuenta-save-1" id="dia" name="ciudad" maxlength="255" value="'.$datos['ciudad'].'" />
		...
		<div class="content-tabs perfil" style="display: none">
			...
			<fieldset>
				...
				<div class="field">
					...
					<input style="width:230px" type="text" class="text cuenta-save-2" id="sitio_web" name="sitio_web" maxlength="60" value="'.$datos['sitio_web'].'" />
				</div>
				...
				<div class="field">
					...
					<input type="text" class="text cuenta-save-2" id="mensajero" name="mensajero" maxlength="64" value="'.$datos['mensajero'].'" />
				</div>
				<div class="field">
...
echo '
			...
			<fieldset style="display: none">
				...
				<div class="field">
					...
					<div class="input-fake">
						<input type="text" class="text cuenta-save-3" id="altura" name="altura" maxlength="3" value="'.$datos['altura'].'" /> cent&iacute;metros
					</div>
				</div>
				<div class="field">
					<label for="peso">Mi peso</label>
					<div class="input-fake">
						<input type="text" class="text cuenta-save-3" id="peso" name="peso" maxlength="3" value="'.$datos['peso'].'" /> kilogramos
					</div>
...
echo '</select>
				...
				<div class="field">
					...
					<input value="'.$datos['profesion'].'" id="profesion" name="profesion" maxlength="32" class="text cuenta-save-4"/>
				</div>
				<div class="field">

					<label for="empresa">Empresa</label>
					<input value="'.$datos['empresa'].'" id="empresa" name="empresa" maxlength="32" class="text cuenta-save-4"/>
				</div>
				<div class="field">
...
';
  if(isset($_POST['mostrar_estado_checkbox']))
  {
    echo "Ficer wasnt here (?)";
  }
...
if(!mysql_num_rows($sql)){ echo'<div class="emptyData">No tienes usuarios bloqueados.</div>';}
...
<div class="floatR">
	...
	<div class="sidebar-tabs">
		...
		<div class="webcam-capture" style="display: none; margin: 0 0 0 10px">
			...
			<param name="flashvars" value="id=257&s=3&crc=bf49a9b1c02edf69fd627b5310e5c70042a5fccf&texto=Tomar+foto&host=/upload.php" />
...
<iframe src="/avatar.php" frameborder="0" width="200" height="55" scrolling="no"></iframe>
...
<!-- Vincular Facebook By Lean18 (Zincomienzo) -->	
<br>		
...
<div id="ver_on"><a href="#facebook" class="facebook-vinc" onclick="mostrar(\'bloque\')">Vincular con Facebook</a></div>
<div id="ver_off" style="display: none"><a href="#facebook" onclick="ocultar(\'bloque\')"></a></div>	


<div style="display: none" id="bloque">



<div class="field">
					<label for="nombre"><b>URL de tu Facebook:</b></label>

<input type="text" class="text cuenta-save-1" id="dia" name="facebook" maxlength="255" value="'.$datos['facebook'].'" />
</div>
...
<a href="/cambiar-color"><img src="/images/cambiar-color.png"></a>
...
<script type="text/javascript">
				var twitter = {
					link: function(){
						var twitter_window = window.open(\'/twitter_link.php\',\'Vincular mi cuenta con Twitter\', \'width=200,height=200,scrollbars=NO,resizable=NO\'),
...
.twitter-vinc {
	...
	width: 161px;
	height: 22px;
	background: url("/images/indentificarme-twt.png") no-repeat transparent;
	text-indent: -99999px;
}
...
.twitter-vinc:active, .twitter-vinc:focus{
...
.twitter-login,social-connect a.twitter-login {
	...
	background: url("/images/indentificarme-twt.png") no-repeat transparent!important;
	text-indent: -99999px;
}


.tabbed-d div.twitter-box-out {
	background:url("/images/twitter-box.jpg") no-repeat scroll 60px 3px #FFF;
	padding: 8px;
