 ...
 */
 if (empty($_GET['pagina'])){
	...
	// La página actual será la que se pidió.
    	$_pagi_actual = xss(no_i($_GET['pagina']));
 }
//------------------------------------------------------------------------
 ...
 */
 ...
 if(!isset($_pagi_propagar)){
	...
	//Perdón... no todo el $_GET. Todo menos la variable pagina
	if (isset($_GET['pagina'])) unset($_GET['pagina']); // Eliminamos esa variable del $_GET
...
// Si no estamos en la página 1. Ponemos el enlace "anterior"
	...
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."pagina=".$_pagi_url."'>$_pagi_nav_anterior</a>";
 }
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."pagina=".$_pagi_url."'>$_pagi_nav_siguiente</a>";
 }
