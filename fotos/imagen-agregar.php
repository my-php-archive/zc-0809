...
if(empty($key)){
	fatal_error('Para subir fotos debes estar logeado!','Ir a p&aacute;gina principal','location.href=\'/\'','Error');
}
...
<div class="container">              
                    ...
                    <form name="add_foto" method="post" action="/fotos/imagen-agregada" enctype="multipart/form-data" id="foto_form" class="form-add-post" autocomplete="off">
...
<div class="fade_out">
                        <ul class="clearbeta">
                          ...
                          <input class="text-inp required" type="text" name="foto" maxlength="255" tabindex="1" style="width: 410px" />
                            </li>
                                                                                <li>
                            <label for="fdesc">Descripci&oacute;n</label>

                            <span style="display: none;" class="errormsg"></span>
                         <textarea name="contenido" id="fdesc" cols="60" rows="5" onkeydown="return ControlLargo(this);" onkeyup="return ControlLargo(this);"></textarea>
