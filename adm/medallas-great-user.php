...
<br><br>
<div class="globo-small"><span style="color: #0033CC;"><img src="/images/medalla-great.png" align="absmiddle"><a href="great-user"> Great User</a></div></span>
<br><br>
...
<div class="boxy xtralarge2">
			...
			<div class="boxy-content">
<?php
	$_pagi_sql = "SELECT * FROM medallas WHERE causa='Great User'";
