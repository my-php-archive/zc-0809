...
<br><br>
<div class="globo-small"><span style="color: #0033CC;"><img src="/images/medalla-administrador.png" align="absmiddle"><a href="desarrollador"> Desarrollador</a></div></span>
<br><br>
...
<br><br>
<img src="/images/medalla-gold.png" align="absmiddle"><a href="gold-user"> Gold User</a>
<br><br>
...
<div class="boxy xtralarge2">
			...
			<div class="boxy-content">
<?php
	$_pagi_sql = "SELECT * FROM medallas WHERE causa='Desarrollador'";
