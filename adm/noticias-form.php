...
<form name="Fdenuncia" action="/adm/noticias.php" method="post">


  
<br>
<center><h2><b>Titulo:</b></h2> <textarea class="publi2" name="titulo"></textarea> <br /></center>
<br>
<center><h2><b>Cuerpo:</b></h2> <textarea class="publi" name="comentarios" id="markItUp"></textarea></center>
<br />
<br>
<hr class="divider">
<center><input type="submit" class="mBtn btnGreen" style="width:auto; margin-left: 5px" value="Publicar noticia" title="Publicar noticia"/></center>
<hr class="divider">
</div>
</form>
...
<td><?=$row['id'];?></td>
<td><?=$row['titulo'];?></td>
<td><a id="change_status" onclick="javascript:borrar_noticia('<?=$row['id']?>')" title="Borrar"><img src="http://zincomienzo.net/images/borrar.png" align="absmiddle"></a></td>
