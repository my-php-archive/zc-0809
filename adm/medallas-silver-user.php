...
<br><br>
<div class="globo-small"><span style="color: #0033CC;"><img src="/images/medalla-silver.png" align="absmiddle"><a href="silver-user"> Silver User</a></div></span>
<br><br>
...
<div class="boxy xtralarge2">
			...
			<div class="boxy-content">
<?php
	$_pagi_sql = "SELECT * FROM medallas WHERE causa='Silver User'";
