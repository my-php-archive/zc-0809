...
<div class="boxy xtralarge2">
			<div class="boxy-title">
				<h3>Lista de rangos disponibles</h3>
	...
	<tbody>
		<tbody>
<?php
$sql=mysql_query("SELECT * FROM rangos ORDER BY nom_rango DESC");
...
<td><b>".$row[nom_rango]."</b></td>
	
<td><span style='position:relative;'><img border=0 src='/images/big2v1.png' style='".$row[img_rango]."' alt='Moderador' title='Moderador' /><img border=0 src='/images/space.gif' style='width:17px;height:16px' align='absmiddle' /></span></td>
