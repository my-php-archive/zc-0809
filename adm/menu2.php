...
<div class="right" style="float:left;margin-left:0px;width:985px">
		<div class="boxy xtralarge">
			<div class="boxy-title">
				<h3>Administraci&oacute;n De <font color="green">Comunidades</font></h3>
...
<img src="/images/inicio.png" align="absmiddle" height="17" width="18"/> <a href="/adm" class="m-menu">Inicio</a> <br />
<hr>
<img src="/images/suspendidas-icon.png" align="absmiddle" /> <a href="/adm/comunidades/Comunidades-Suspendidas/" class="m-menu">Comunidades Suspendidas</a> <br />
<img src="/images/delete.png" align="absmiddle" /> <a href="/adm/comunidades/borrar-temas" class="m-menu">Borrar Temas</a> <br />
<hr>
<img src="/images/oficial-icon.png" align="absmiddle" height="20" width="20" /> <a href="/adm/Comunidades-Oficiales/" class="m-menu">Comunidades Oficiales</a><br />
...
.boxy-title {
	background: #d9d9d9 url('') repeat-x top left;
	padding: 10px;
