...
<?php include("menu2.php");?>
		<div class="boxy xtralarge2">
			<div class="boxy-title">
				<h3>Normas y Reglas De Un Moderador &oacute; Administrador</h3>
...
<li><span class="color_red">
<img src="<?=$images?>/images/sticky.gif" align="absmiddle" vspace="2">&nbsp;&nbsp;No hagas lio aca, sino se pudre todo...</span></li>
<hr class="divider">
<li><span class="color_green">
<img src="<?=$images?>/images/sticky.gif" align="absmiddle" vspace="2">&nbsp;&nbsp;Un moderador es un usuario con mayores privilegios en la web, con lo cual implica una mayor responsabilidad.</span></li>
<hr class="divider">
<li><span class="color_red">
<img src="<?=$images?>/images/sticky.gif" align="absmiddle" vspace="2">&nbsp;&nbsp;Un error de uno, es un error de todos. </span></li>

<hr class="divider">
<li><span class="color_red">
<img src="<?=$images?>/images/sticky.gif" align="absmiddle" vspace="2">&nbsp;&nbsp;Un moderador no puede insultar, maltratar, trollear, ni burlarse de los dem&aacute;s. Si nosotros lo hacemos, lo estamos permitiendo.</span></li>

<hr class="divider">
<li><span class="color_red">
<img src="<?=$images?>/images/sticky.gif" align="absmiddle" vspace="2">&nbsp;&nbsp;No se pueden Desuspender usuarios que suspendio otro moderador salvo que se haya cumplido el tiempo de suspencion, ante cualquier inquietud hablar con el moderador que puso la suspencion para llegar a un acuerdo en comun.</span></li></strong></font>
