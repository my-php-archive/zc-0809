...
<div class="container940">
		<div class="box_title">
			...
			<div class="box_txt juegos_container">Juegos Zincomienzo! - Ajedrez</div>
			...
			<div class="box_cuerpo" align="center">
				...
				<table width="600" height="36" border="0" cellspacing="4" align="left" bgcolor="#FFFFFF">
					...
					<img  src="http://o2.t26.net/images/head-ajedrez.png">
				  ...
				  <tr>
				   <td width="85" height="30" class="size13"><img title="Sal&oacute;n" src="http://o2.t26.net/images/icon-ajedrez.gif" alt="Sal&oacute;n de Ajedrez" hspace="4"  border="0" align="absmiddle"><strong>Sal&oacute;n 1</strong></td>
				    <td width="270" align="center" class="size13"><strong></strong><strong></strong></td>

				    <td  align="center">
					
						
					<a href="javascript:Abrir_juego('/juegos/ajedrez/ajedrez.php')"><img title="Sal&oacute;n" src="http://o2.t26.net/images/btn-jugar.gif" alt="Sal&oacute;n de Ajedrez" border="0" align="absmiddle"></a>
									    </td>
				  </tr>
				  ...
				  <tr>
				    <td width="85" height="30" class="size13"><img title="Sal&oacute;n" src="http://o2.t26.net/images/icon-ajedrez.gif" alt="Sal&oacute;n de Ajedrez" border="0" hspace="4"  align="absmiddle"><strong>Sal&oacute;n 2</strong></td>
				    <td width="270" align="center" class="size13"><strong></strong><strong></strong></td>
				    <td  align="center">
					
						
					<a href="javascript:Abrir_juego('/juegos/ajedrez/ajedrez.php')"><img title="jugar al ajedrez" src="http://o2.t26.net/images/btn-jugar.gif" alt="jugar al ajedrez" border="0"></a>
